...
NUMBERCOIN = 0
# Настройка шрифтов
font = pygame.font.Font('/Users/rustammusagaliev/Documents/University study/semestr 2/GIT/pp2-22B030166/tsis8/10922.otf', 90)
font_small = pygame.font.SysFont("Verdana", 20)
game_over = font.render("Game Over", True, BLACK)
background = pygame.image.load("/Users/rustammusagaliev/Documents/University study/semestr 2/GIT/pp2-22B030166/tsis8/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/rustammusagaliev/Documents/University study/semestr 2/GIT/pp2-22B030166/tsis8/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/rustammusagaliev/Documents/University study/semestr 2/GIT/pp2-22B030166/tsis8/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/rustammusagaliev/Documents/University study/semestr 2/GIT/pp2-22B030166/tsis8/bitcoin.png")
...
class Coin2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/rustammusagaliev/Documents/University study/semestr 2/GIT/pp2-22B030166/tsis8/coin2.png")
        self.image = pygame.transform.scale(self.image, (30, 30))
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        ...
        pygame.mixer.Sound('/Users/rustammusagaliev/Documents/University study/semestr 2/GIT/pp2-22B030166/tsis8/crash.wav').play()
        time.sleep(1)

        DISPLAYSURF.fill(RED)
        pygame.mixer.Sound('/Users/rustammusagaliev/Documents/University study/semestr 2/GIT/pp2-22B030166/tsis8/game_over_theme.mp3').play()
