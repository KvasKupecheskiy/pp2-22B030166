...
snd1 = pygame.mixer.Sound("tsis7\snds\Rick Astley - Never Gonna Give You Up.mp3") # грузим треки
snd2 = pygame.mixer.Sound("tsis7\snds\Michael Jackson - Billie Jean.mp3")
...
text1 = basicFont.render('tsis7\snds\Rick Astley - Never Gonna Give You Up', True, 'black', 'white') # создаём текста
text2 = basicFont2.render('Michael Jackson - Billie Jean', True, 'black', 'white')
